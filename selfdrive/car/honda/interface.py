...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    if candidate == CAR.CIVIC:
      ...
      ret.minSteerSpeed = 0 if eps_modified else 12 * CV.MPH_TO_MS
      ...
      ret.minSteerSpeed = 2 * CV.MPH_TO_MS if candidate in CAR.CIVIC_BOSCH else 12 * CV.MPH_TO_MS #TODO Civic Hatch is 12mph, but is apart of the other Bosch civics with 3mph steering, need a way to split the two
      ...
      #ret.minSteerSpeed = 0 #TODO - Verify, might only be 0 with a pedal
